...
class ErgativeObject {
    ...
    constructor(target) {
        ...
        let transmitter = {
            pluck(name) {
                if (arrayMap.hasOwnProperty(name)) {
                    return arrayMap[name].transmitter;
                }
                else if (functionMap.hasOwnProperty(name)) {
                    return functionMap[name].transmitter;
                }
                else if (objectMap.hasOwnProperty(name)) {
                    return objectMap[name].transmitter;
                }
            },
            transmit(receiver) {
